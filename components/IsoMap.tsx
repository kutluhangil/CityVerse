            ...
            if (variant < 33) {
              ...
              return (
                <>
                  ...
                  <mesh {...commonProps} material={rndRoofMat} geometry={coneGeo} position={[0, 0.75, 0]} scale={[0.6, 0.4, 0.6]} rotation={[0, Math.PI/4, 0]} />
                  {hasChimney && <mesh {...commonProps} material={new THREE.MeshStandardMaterial({color: '#7f1d1d', opacity, transparent})} geometry={boxGeo} position={[0.2, 0.6, 0]} scale={[0.1, 0.4, 0.1]} />}
              ...
              return (
                <>
                  ...
                  <mesh {...commonProps} material={secondaryColor} geometry={boxGeo} position={[0.25, 0.25, 0.1]} scale={[0.4, 0.5, 0.6]} />
                  <WindowBlock position={[-0.1, 0.5, 0.41]} scale={[0.4, 0.2, 0.05]} />
                  {hash > 0.7 && <WindowBlock position={[0.25, 0.3, 0.41]} scale={[0.2, 0.2, 0.05]} />}
                </>
              );
            } else {
              // Townhouse
              const stories = 1 + Math.floor(hash * 2.5); // 1 to 3 stories
              ...
              return (
                <>
                  ...
                  {Array.from({length: stories}).map((_, i) => (
                    <WindowBlock key={i} position={[0, 0.25 + i * 0.4, 0.31]} scale={[0.3, 0.2, 0.05]} />
                  ))}
                  <mesh {...commonProps} material={accentMat} geometry={boxGeo} position={[0, 0.1, 0.32]} scale={[0.15, 0.2, 0.05]} />
                </>
              );
            ...
            if (variant < 40) {
              ...
              return (
                <>
                  ...
                  <mesh {...commonProps} material={new THREE.MeshStandardMaterial({ color: awningColor, opacity, transparent })} geometry={boxGeo} position={[0, 0.55, 0.5]} scale={[0.9, 0.1, 0.2]} rotation={[Math.PI/6, 0, 0]} />
                </>
              );
            } else {
              // Corner store
               return (
                <>
                  ...
                  <mesh {...commonProps} material={new THREE.MeshStandardMaterial({color: hash > 0.5 ? '#9ca3af' : '#fbbf24', opacity, transparent})} geometry={boxGeo} position={[0.2, 0.65, 0.2]} scale={[0.2, 0.15, 0.2]} />
                </>
               )
            }
            ...
            if (variant < 50) {
              ...
              return (
                <>
                  ...
                  {stackCount > 1 && <SmokeStack position={[0.3, 0.4, -0.2]} />}
                  <WindowBlock position={[0, 0.3, 0.41]} scale={[0.3, 0.2, 0.05]} />
                </>
              );
            } else {
              // Warehouse
              return (
                <>
                  ...
                  <mesh {...commonProps} material={new THREE.MeshStandardMaterial({color: hash > 0.5 ? '#6b7280' : '#4b5563', opacity, transparent})} geometry={boxGeo} position={[0.25, 0.7, 0]} scale={[0.05, 0.05, 0.5]} />
                  {hash > 0.3 && <mesh {...commonProps} material={new THREE.MeshStandardMaterial({color: '#eab308', opacity, transparent})} geometry={boxGeo} position={[-0.46, 0.15, 0]} scale={[0.05, 0.2, 0.3]} />}
                </>
              );
            }
